...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`hotel` (
  ...
  `citta` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Hotel_Città1_idx` (`citta` ASC),
  CONSTRAINT `fk_Hotel_Città1`
    FOREIGN KEY (`citta`)
...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`collegamenti` (
  ...
  PRIMARY KEY (`codice`),
  INDEX `fk_Collegamento_Città1_idx` (`cittaArrivo` ASC),
  INDEX `fk_Collegamento_Città2_idx` (`cittaPartenza` ASC),
  CONSTRAINT `fk_Collegamento_Città1`
    FOREIGN KEY (`cittaArrivo`)
    REFERENCES `traveldreamdb`.`citta` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Collegamento_Città2`
...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`escursioni` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Escursione_Città2_idx` (`idCitta` ASC),
  CONSTRAINT `fk_Escursione_Città2`
    FOREIGN KEY (`idCitta`)
    REFERENCES `traveldreamdb`.`citta` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`destinazioni` (
  ...
  INDEX `fk_Destinazione_Città2_idx` (`citta` ASC),
  ...
  CONSTRAINT `fk_Destinazione_Hotel2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Destinazione_Città2`
    FOREIGN KEY (`citta`)
    REFERENCES `traveldreamdb`.`citta` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`attivita` (
  ...
  INDEX `fk_Attività_Destinazione2_idx` (`idDestinazione` ASC),
  INDEX `fk_Attività_Escursione2_idx` (`idEscursione` ASC),
  CONSTRAINT `fk_Attività_Destinazione2`
    FOREIGN KEY (`idDestinazione`)
    REFERENCES `traveldreamdb`.`destinazioni` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Attività_Escursione2`
...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`citta_origine_pred` (
  ...
  INDEX `fk_CittàOriginePred_PacchettoPredefinito1_idx` (`idPacchettoPredefinito` ASC),
  INDEX `fk_CittàOriginePred_Città1_idx` (`idCitta` ASC),
  CONSTRAINT `fk_CittàOriginePred_PacchettoPredefinito1`
    FOREIGN KEY (`idPacchettoPredefinito`)
    REFERENCES `traveldreamdb`.`pacchetti_predefiniti` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CittàOriginePred_Città1`
    FOREIGN KEY (`idCitta`)
    REFERENCES `traveldreamdb`.`citta` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `traveldreamdb`.`attivita_pred` (
  ...
  INDEX `fk_AttivitàPred_Escursione1_idx` (`idEscursione` ASC),
  INDEX `fk_AttivitàPred_PacchettoPredefinito2_idx` (`idPacchettoPredefinito` ASC),
  CONSTRAINT `fk_AttivitàPred_Escursione1`
    FOREIGN KEY (`idEscursione`)
    REFERENCES `traveldreamdb`.`escursioni` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AttivitàPred_PacchettoPredefinito2`
    FOREIGN KEY (`idPacchettoPredefinito`)
    REFERENCES `traveldreamdb`.`pacchetti_predefiniti` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
