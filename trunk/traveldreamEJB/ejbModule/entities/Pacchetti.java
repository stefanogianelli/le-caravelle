...
@NamedQueries ({
	...
	@NamedQuery(name="Pacchetti.getPacchettiPredefiniti", query="SELECT p FROM Pacchetti p WHERE p.pacchettoPredefinito = :predefinito")
...
public class Pacchetti implements Serializable {
	...
	@ManyToMany(cascade={CascadeType.PERSIST, CascadeType.MERGE}, mappedBy="pacchetti")
